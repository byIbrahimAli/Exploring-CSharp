...
namespace WiredBrainCoffeeSurveys.Reports
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Response Percentage: {responseRate}"); // needs $ prefix to print var in string
            ...
            bool noGranolaYesCappucino = Q1Results.LeastFavoriteProduct == "Granola" && Q1Results.FavoriteProduct == "Cappucino"; // performs comparison == and not assignment =
...
// Don't know what they wanted me to do with this crap:
